  ...
  render() {
    return (
      <div>
        ...
        <p>
          L'escalade ne se pratique pas que sur de la résine ! Le mieux est de grimper le plus souvent possible sur du rocher. Toutes les roches permettent des préhensions différentes et donc une escalade différente.
        </p>
        ...
        <p>
          ...
          <br />
          Le pique-nique n'est pas fourni par le club pour ces sorties. 
        </p>
        ...
        <p>
          ...
          <br />
          Un week-end en camping est organisé en mai pour les jeunes.
          <br />
          Pour les adultes, un ou deux week-ends avec hébergement en camping ou en gîte sont organisés. 
        </p>

        <p>
          Les sites choisis sont le plus souvent en Bourgogne (Cormot, Vieux Château, Le Saussois, Saffres...), mais d'autres sites d'escalade en Normandie (Clécy), en Champagne (Vertus) ou en Mayenne (Saulges) font également partis des sites visités lors des sorties.
        </p>
        ...
        <p>
          La section organise ponctuellement des sorties sur plusieurs jours qui vont du simple week-end en montagne à des stages de perfectionnement en France ou à l'étranger et propose des stages et des séances d'initiation à diverses activités (via ferrata, glacier, canyonisme...).
          <br />
